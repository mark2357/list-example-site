...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function srcDataNodeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var DataNode = /*#__PURE__*/function () {
      function DataNode(id, name, parentId, value, nodeList) {
        ...
        if (nodeList[this.parentId] !== undefined) {
          var parentNode = nodeList[this.parentId];
      ...
      _createClass(DataNode, [{
        ...
        key: "addParentNode",
        value: function addParentNode(node) {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _data_list_data_list_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./data-list/data-list.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_data_list_data_list_component__WEBPACK_IMPORTED_MODULE_1__["DataListComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _data_list_data_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./data-list/data-list.component */
    "./src/app/data-list/data-list.component.ts");
    /* harmony import */
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"], _data_list_data_list_component__WEBPACK_IMPORTED_MODULE_3__["DataListComponent"], _list_item_list_item_component__WEBPACK_IMPORTED_MODULE_4__["ListItemComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppDataListDataListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DataListComponent", function () {
    ...
    var _DataNode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../DataNode */
    "./src/DataNode.ts");
    /* harmony import */


    var _assets_sampledata_csv__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../assets/sampledata.csv */
    "./src/assets/sampledata.csv");
    /* harmony import */


    var _assets_sampledata_csv__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_assets_sampledata_csv__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */


    var _list_item_list_item_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../list-item/list-item.component */
    "./src/app/list-item/list-item.component.ts");

    var DataListComponent = /*#__PURE__*/function () {
      function DataListComponent() {
        var _this = this;

        _classCallCheck(this, DataListComponent);

        // contains dictionary of all nodes
        this.nodeList = {}; // the currently selected node (nodes that are not child nodes will not be visible) will be null if there is no selected node

        this.selectedNode = null; // list that contains data of which nodes are displaying there children
        ...
        this.analyseData = function () {
          ...
          _assets_sampledata_csv__WEBPACK_IMPORTED_MODULE_2___default.a.forEach(function (item) {
            var dataNode = new _DataNode__WEBPACK_IMPORTED_MODULE_1__["DataNode"](item.id, item.name, item.parent_id, item.value, _this.nodeList);
            _this.nodeList[item.id] = dataNode;
          });

          var firstKey = Object.keys(_this.nodeList)[0];
          _this.rootNode = _this.nodeList[firstKey]; // iteratively determines the total value for each node in the tree 

          _this.rootNode.calculateTotalValue(); // initializes the dictionary used to store weather each list item is open 


          Object.keys(_this.nodeList).forEach(function (key) {
            _this.listItemChildrenVisible[key] = true;
          });
        };
        /**
         * @description
        ...
        this.handleSetChildrenVisibility = function (id, value) {
          _this.listItemChildrenVisible[id] = value;
        };
        /**
         * @description
        ...
        this.handleSetSelectedNode = function (id) {
          _this.selectedNode = _this.nodeList[id];
        };
        /**
         * @description
        ...
        this.handleClearSelectedNode = function () {
        ...
        this.handleExpandAllItems = function () {
          Object.keys(_this.listItemChildrenVisible).forEach(function (key) {
            _this.listItemChildrenVisible[key] = true;
          });
        };
        /**
        ...
        this.handleCollapseAll = function () {
          Object.keys(_this.listItemChildrenVisible).forEach(function (key) {
            _this.listItemChildrenVisible[key] = false;
          });
        };
      }

      _createClass(DataListComponent, [{
        key: "ngOnInit",
    ...
    DataListComponent.ɵfac = function DataListComponent_Factory(t) {
      return new (t || DataListComponent)();
    };

    DataListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DataListComponent,
      selectors: [["app-data-list"]],
      decls: 13,
      vars: 5,
      consts: [[1, "data-list"], [1, "header-wrapper"], [3, "click"], [3, "disabled", "click"], [1, "list-wrapper"], [3, "dataNode", "setChildrenVisibility", "setSelectedNode", "listItemChildrenVisible"]],
      template: function DataListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DataListComponent_Template_button_click_5_listener() {
            return ctx.handleExpandAllItems();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DataListComponent_Template_button_click_7_listener() {
            return ctx.handleCollapseAll();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DataListComponent_Template_button_click_9_listener() {
            return ctx.handleClearSelectedNode();
          });
  ...
  /***/
  function srcAppListItemListItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function ListItemComponent_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var ListItemComponent = /*#__PURE__*/function () {
      function ListItemComponent() {
         ...
         */
        this.handleToggleChildren = function () {
          // only bother toggling children if there are children to hide and show
          if (_this2.dataNode.childNodes.length > 0) {
            _this2.setChildrenVisibility(_this2.dataNode.id, !_this2.childrenVisible);
          }
        };
        /**
         * @description
        ...
        this.handleExpandAllChildren = function () {
          _this2.setHierarchyVisible(_this2.dataNode);
        };
        /**
         * @description
        ...
        this.setHierarchyVisible = function (node) {
          _this2.setChildrenVisibility(node.id, true);

          node.childNodes.forEach(function (node) {
            _this2.setHierarchyVisible(node);
          });
        };
      }
    ...
    ListItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      inputs: {
        ...
        listItemChildrenVisible: "listItemChildrenVisible"
      },
      decls: 12,
      vars: 9,
      consts: [[1, "list-item"], [1, "item-wrapper"], [3, "click"], [1, "text-wrapper", 3, "click"], [3, "class", 4, "ngFor", "ngForOf"], [3, "dataNode", "setChildrenVisibility", "setSelectedNode", "listItemChildrenVisible"]],
      template: function ListItemComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListItemComponent_Template_div_click_2_listener() {
            return ctx.handleToggleChildren();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListItemComponent_Template_div_click_4_listener() {
            return ctx.handleToggleChildren();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ListItemComponent_Template_button_click_9_listener() {
            return ctx.setSelectedNode(ctx.dataNode.id);
          });
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], ListItemComponent],
  ...
  /***/
  function srcAssetsSampledataCsv(module, exports) {
    module.exports = [{
      "id": 1,
      "name": "Kropf",
      "parent_id": 1,
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! F:\WebProjects\Angular Sites\list-example\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
